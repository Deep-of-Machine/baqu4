                ...
                if len(right_line) > 1 and len(left_line) > 1:          ## 양쪽 차선이 다 있을때
                    ...
                    if len(virtual_left_line) > 0:
                        ...
                        if 80 < steering_theta(virtual_left_line[0], right_calculated_weight) < 100:
                            ...
                            print("기울기 조향 서보모터 각도: ", steering_theta(virtual_left_line[0], right_calculated_weight))
                    ...
                    if len(virtual_right_line) > 0:
                        ...
                        if 80 < steering_theta(left_calculated_weight, virtual_right_line[0]) < 100:
                            ...
                            print("기울기 조향 서보모터 각도: ", steering_theta(left_calculated_weight, virtual_right_line[0]))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-size', type=int, default=32*13, help='size of each image dimension') # best 32* 20                 #32*13
    parser.add_argument('--conf-thres', type=float, default=0.01, help='object confidence threshold') #best!!!! 0.01                       #0.5
    parser.add_argument('--nms-thres', type=float, default=0.00000000000000001, help='iou threshold for non-maximum suppression') # 0.01         #0.45
